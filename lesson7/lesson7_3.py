...
class Cell:
    def __init__(self, sellqty):
        if sellqty > 0:
            self.sellqty = sellqty
        else:
            print("Кол-во ячеек должно быть больше 0")

    def __add__(self, other):
        return Cell(self.sellqty + other.sellqty)

    def __sub__(self, other):
       if self.sellqty-other.sellqty > 0:
            return Cell(self.sellqty-other.sellqty)
       else:
            print("Кол-во ячеек во 2ой клетке должно быть меньше кол-ва ячеек 1ой")
